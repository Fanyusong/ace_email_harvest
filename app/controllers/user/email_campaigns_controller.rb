class User::EmailCampaignsController < User::BaseController
  ...
  def show
    ...
    @open_count = @email_campaign.messages.where("ahoy_messages.opened_at IS NOT NULL").group_by_day(:opened_at, range: @email_campaign.start_time.yesterday..@email_campaign.end_time)
